...
Proof.
  ...
  - reflexivity.
  - simpl. {
    induction n. simpl. rewrite ble_n_Sn. reflexivity.
...
(** Write down an interesting theorem [bag_count_sum] about bags
    ...
    [count]!) *)
Theorem bag_count_sum : forall s1 s2 : bag, forall v : nat, count v (sum s1 s2) = (count v s1) + (count v s2).
...
(* The type baz has a countably infinite number of elements. *)
(* FILL IN HERE *)
*)
(** [] *)

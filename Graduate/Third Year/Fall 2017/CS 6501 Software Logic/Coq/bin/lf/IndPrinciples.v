...
(*
An induction principle is a scheme for proving
that a given property, [P], is true of *all* elements of a given
type.
*)
...
forall P : natlist1 -> Prop,
  P nnil1 -> (forall (n : nat) (n0 : natlist),
    P n0 -> P (ncons n n0)) ->
  forall n : natlist1, P n -> forall n0 : nat,
    P (nscnoc1 n n0) -> forall n : natlist1, P n
*)
...
forall P : byntree -> Prop,
  ...
  (forall (y : yesno) (b : byntree), P b ->
  forall b 0 : byntree, P b0 -> P (nbranch y b b0)) ->
...
forall (x : Type) (P : tree X -> Prop),
  ...
  (forall t : tree X, P t -> forall t0 : tree X, P t0 ->
  P (node X t t0)) -> forall t : tree X, P t
*)

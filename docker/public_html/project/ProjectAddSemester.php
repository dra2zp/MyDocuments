...
<html lang="en">
	...
	<nav>
		<ul class="nav nav-pills" id="options">
			...
			<li role="presentation" class="active"><a href="ProjectAddSemester.php" id="add"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>   Add a Semester</a></li>
			<li role="presentation"><a href="ProjectDeleteSemester.php" id="delete"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span>   Delete a Semester</a></li>
	...
	<p>&nbsp</p>
	<body>
		<h1><strong>Add a Semester</strong></h1>
		<form action="ProjectController.php?request=newSemester" method="POST">
			<div class="container">
				<h3><strong>Semester Information</strong></h3>
				<label for="semester"><strong>Semester</strong></label>
				<input id="semester" name="semester" type="text" placeholder="Enter Semester Name" required maxlength="20"></input>
				<br>
				<button type="submit" name="cmd" value="addSemester">Add Semester</button>
			</div>
		</form>
	</body>

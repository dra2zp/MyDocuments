...
<html lang="en">
	...
	<nav>
		<ul class="nav nav-pills" id="options">
			...
			<li role="presentation" class="active"><a href="ProjectRemoveClass.php" id="remove"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>   Remove a Class</a></li>
	...
	<p>&nbsp</p>
	<body>
		<h1><strong>Remove a Class</strong></h1>
		<form action="ProjectController.php?request=deleteClass" method="POST">
			<div class="container">
				<div class="container" id="classes">
					<label for="title"><strong>Select which class to remove</strong></label>
					<br>
					
				</div>
				<button type="submit" name="cmd" value="removeClass">Remove Class</button>
			</div>
		</form>
	</body>
	...
	<footer>
		...
		<script src="ProjectRemoveClass.js"></script>
	</body>
</html>